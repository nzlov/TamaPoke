...
enum StrId : uint16_t {
  ...
  S_TR_DEF_HINT,    // reserved legacy catalogue position; no longer rendered
  ...
  // daily task centre (append-only)
  S_TASK_CENTER, S_TASK_SUBMIT, S_TASK_COMPLETED, S_TASK_CHOOSE,
