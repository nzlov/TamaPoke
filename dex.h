...
static const DexEntry DEX_TBL[DEX_COUNT + 1] = {
  ...
  { "TOGETIC", 0, 0, R_EVO, 0xC333, 55, 40, 85, 40, 80, 105, 0, T_FAIRY, T_FLYING },  // 176 fairy/flying
  ...
  { "SUDOWOODO", 0, 0, R_COMUN, 0x9407, 70, 100, 115, 30, 30, 65, 4, T_ROCK, T_NONE },  // 185 rock
  ...
  { "AIPOM", 0, 0, R_RARO, 0x8C4D, 55, 70, 55, 85, 40, 55, 0, T_NORMAL, T_NONE },  // 190 normal
  ...
  { "YANMA", 0, 0, R_COMUN, 0x7CC4, 65, 65, 45, 95, 75, 45, 2, T_BUG, T_FLYING },  // 193 bug/flying
  ...
  { "MURKROW", 0, 0, R_RARO, 0x5A47, 60, 85, 42, 91, 85, 42, 2, T_DARK, T_FLYING },  // 198 dark/flying
  { "SLOWKING", 0, 0, R_COMUN, 0x4C98, 95, 75, 80, 30, 100, 110, 1, T_WATER, T_PSYCHIC },  // 199 water/psychic
  { "MISDREAVUS", 0, 0, R_RARO, 0x6AD3, 60, 60, 60, 85, 85, 85, 0, T_GHOST, T_NONE },  // 200 ghost
  ...
  { "PILOSWINE", 0, 0, R_EVO, 0x4DB8, 100, 100, 80, 50, 60, 60, 5, T_ICE, T_GROUND },  // 221 ice/ground
  ...
  { "MANTINE", 0, 0, R_RARO, 0x4C98, 85, 40, 70, 70, 80, 140, 1, T_WATER, T_FLYING },  // 226 water/flying
  ...
  { "NOSEPASS", 0, 0, R_COMUN, 0x9407, 30, 45, 135, 30, 45, 90, 4, T_ROCK, T_NONE },  // 299 rock
  ...
  { "ROSELIA", 0, 0, R_COMUN, 0x3C49, 50, 60, 45, 65, 100, 80, 2, T_GRASS, T_POISON },  // 315 grass/poison
  ...
  { "DUSCLOPS", 0, 0, R_EVO, 0x6AD3, 40, 70, 130, 25, 60, 130, 0, T_GHOST, T_NONE },  // 356 ghost
  { "TROPIUS", 0, 0, R_COMUN, 0x3C49, 99, 68, 83, 51, 72, 87, 2, T_GRASS, T_FLYING },  // 357 grass/flying
  { "CHIMECHO", 0, 0, R_RARO, 0xD28F, 75, 50, 80, 65, 95, 90, 0, T_PSYCHIC, T_NONE },  // 358 psychic
