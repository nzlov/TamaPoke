...
// Player avatars, 16x16, drawn by hand.
//
// They are NOT ripped sprites. SpriteCollab is Pokemon-only -- there is no
// trainer art anywhere in the pipeline -- and pulling ripped art from elsewhere
// would land unlicensed assets in a repo that is careful about exactly that
// (see CREDITS.md; the PMD sprites are CC BY-NC). So these are original
// silhouettes in the same style as the button icons above: a cap, a hair
// colour, a jacket. Kanto and Johto flavoured without copying anyone's pixels.
static const char* const SPR_PLAYER_A[16] = {  // red cap, dark hair
  "................",
  ".....kkkkkk.....",
  "....krrrrrrk....",
  "...krrrrrrrrk...",
...
static const char* const SPR_PLAYER_B[16] = {  // white hat, long brown hair
  "................",
  ".....wwwwww.....",
  "....wwwwwwww....",
  "...wkkkkkkkkw...",
...
static const char* const SPR_PLAYER_C[16] = {  // yellow-black cap, backpack
  "................",
  ".....kkkkkk.....",
  "....kYYYYYYk....",
  "...kYYkkkkYYk...",
...
static const char* const SPR_PLAYER_D[16] = {  // white cap, twin tails
  "................",
  ".....wwwwww.....",
  "....wwwwwwww....",
  "...wkkkkkkkkw...",
