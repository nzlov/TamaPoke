...
needs_sketch() { case "$1" in touch_test|flush_test|joy_test|anim_test|swipe_test|lan_test|console_test|hit_test|battle_debounce_test|battle_reward_ui_test|brightness_test|starter_test|recovery_test|navigation_test|wild_detail_test) return 0;; *) return 1;; esac; }
