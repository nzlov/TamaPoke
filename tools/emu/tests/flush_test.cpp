...
extern bool cardOpen, galleryOpen, clockOpen, kbOpen, menuOpen, navMenuOpen, partyOpen, partyPick;
...
static void clearAll(){
  cardOpen=galleryOpen=clockOpen=kbOpen=menuOpen=navMenuOpen=partyOpen=partyPick=false;
